...
execute_process(
  COMMAND "/opt/homebrew/bin/git" --git-dir=.git show-ref "latest"
  WORKING_DIRECTORY "/Users/matt.swart/Source/Amiga/PaperTanks/_deps/bartman_gcc_support-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/matt.swart/Source/Amiga/PaperTanks/_deps/bartman_gcc_support-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/matt.swart/Source/Amiga/PaperTanks/_deps/bartman_gcc_support-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
